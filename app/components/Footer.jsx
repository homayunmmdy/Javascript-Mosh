            ...
            <div className="mx-auto w-[94%] md:w-[92%] px-4 sm:px-6 lg:px-8">
                ...
                <div className="py-7 border-t border-gray-200">
                    <div className="flex items-center flex-col-reverse justify-between md:flex-row">
                        <span className="text-xs text-gray-500 mt-7 md:mt-0"> تمام حقوق مادی و معنوی این سایت متعلق به <a href="/">{SiteConfig.name}</a> می باشد و استفاده از مطالب با ذکر منبع بلامانع است.</span>
