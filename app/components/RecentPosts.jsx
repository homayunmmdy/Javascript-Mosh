    ...
    return (
        <>
            <div className="bg-gray-100 p-4 rounded-3xl">
                <h2 className="text-xl font-bold text-gray-800 my-4 text-center">پست های اخیر</h2>
                        ...
                        <div className="grid grid-cols-1  gap-y-5 gap-x-3 items-start ">
                            {posts?.map((post) => (
                                <a href={`/Posts/${post._id}`} >
                                    <li className="flex p-2 gap-2 items-center border-dotted border-b-2 border-gray-400 hover:border-gray-900 hover:text-sky-600 hover:border-solid">
                                        <FaCircleDot color='#398DEF' size={25} />
                                        {post.title}
                                    </li>
                                </a>
