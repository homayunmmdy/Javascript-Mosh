		...
		<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4 h-full">
			...
			<div className="col-span-2 sm:col-span-1 md:col-span-2 bg-stone-50">
				...
				<div className="grid gap-4 grid-cols-2 sm:grid-cols-2 lg:grid-cols-2">
					...
					<Link href="learning" className="group relative flex flex-col overflow-hidden rounded-lg px-4 pb-4 pt-40">
						...
						<div className="absolute inset-0 bg-gradient-to-b from-gray-900/25 to-gray-900/5"></div>
						<h3 className="z-10 text-2xl font-medium text-white absolute top-0 left-0 p-4 xs:text-xl md:text-3xl">Learning</h3>
					</Link>
				</div>
			</div>
